...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('user.update', $user->id) }}" method="POST" class="bg-white shadow rounded p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="no_hp" value="{{ old('no_hp', $user->no_hp) }}" class="w-full px-3 py-2 border rounded">
        </div>
        ...
        <div class="mb-4">
            <label class="font-semibold">Password (kosongkan jika tidak ingin mengganti)</label>
